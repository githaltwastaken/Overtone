...
![tests](https://img.shields.io/badge/tests-371%20Python%20%C2%B7%20233%20Rust-6ee7b7)
...
```bash
.venv/Scripts/python.exe -m unittest test_overtone test_overtone_web   # 371 tests
